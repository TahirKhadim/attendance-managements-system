...
const Sidebar = ({ open, setopen }) => {
  ...
  const sidebarItems = [
    ...
    { name: 'Mark Attendance', path: '/user/attendance' },
    { name: 'View Attendance', path: '/user/view-attendance' },
    { name: 'Request Leave', path: '/user/mark-leave' },
    { name: 'Report', path: '/user/view-report' },
  ];
      ...
      <aside className='w-64 border-r hidden bg-background p-6 lg:flex'>
        <div className="sidebar-content p-4">
          <div className="flex justify-between items-center gap-4">
            <ChartNoAxesCombined />
            <h2 className={`text-xl font-extrabold`}>User Panel</h2>
